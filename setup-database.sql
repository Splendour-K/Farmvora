-- FarmVora Database Setup Script
...
-- Insert sample projects (Note: You'll need to create an admin profile first)
-- To create an admin account:
-- 1. Sign up through the app
-- 2. Run: UPDATE profiles SET role = 'admin' WHERE email = 'your-email@example.com';
-- 3. Then you can create projects through the admin dashboard

-- Or manually insert sample projects (replace 'admin-user-id' with actual admin user ID):
-- INSERT INTO projects (title, description, location, category, required_capital, current_funding, expected_roi, duration_months, start_date, expected_harvest_date, risk_level, status, owner_name, owner_bio) VALUES
